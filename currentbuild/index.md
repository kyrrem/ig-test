...
```json
{
  ...
  "id" : "ehin.fhir.hackaton.aidn.no",
  "url" : "http://aidn.no/ehin/fhir/hackaton/ImplementationGuide/ehin.fhir.hackaton.aidn.no",
  "version" : "0.1.0",
  "name" : "EHINFHIRHackatonAidn",
  "title" : "EHIN FHIR Hackaton - Aidn.",
  "status" : "draft",
  "date" : "2025-11-10T10:28:02+00:00",
  "publisher" : "Aidn",
  "contact" : [
    {
      "name" : "Aidn",
  ...
  "description" : "Test av implementasjonsguide EHIN FHIR Hackaton - Aidn",
  "jurisdiction" : [
    {
      "coding" : [
        {
  ...
  "packageId" : "ehin.fhir.hackaton.aidn.no",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [
    {
    ...
    "extension" : [
      ...
      },
      {
        "extension" : [
          ...
          {
            "url" : "value",
            "valueString" : "http://aidn.no/ehin/fhir/hackaton/history.html"
          }
        ],
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
      },
    ...
    "resource" : [
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/AidnEpisodeOfCare"
        },
